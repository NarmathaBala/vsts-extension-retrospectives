...
export interface IFeedbackCarouselProps {
  feedbackColumnPropsList: IFeedbackColumnProps[];
...
export default class FeedbackCarousel extends React.Component<IFeedbackCarouselProps, IFeedbackCarouselState>{
  private renderFeedbackCarouselItems = (feedbackColumnProps: IFeedbackColumnProps) => {
  ...
  private renderSingleFeedbackCarouselItem = (feedbackColumnProps: IFeedbackColumnProps) => {
    return (
